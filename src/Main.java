...
//======================================================================================================================
/*//1
        Vehicle auto = new Auto("Porsche", 10000);
        Thread thread11 = new Thread11(auto);
        thread11.setPriority(Thread.MAX_PRIORITY);
        Thread thread12 = new Thread12(auto);
        thread12.setPriority(Thread.MIN_PRIORITY);
        thread11.start();
        thread12.start();
// 2*/
/*        Auto auto = new Auto("Mark",10);
        VehicleSynchronizer vehicleSynchronizer = new VehicleSynchronizer(auto);
        Runnable thread20 = new Thread20(vehicleSynchronizer);
        Runnable thread21 = new Thread21(vehicleSynchronizer);
        Thread thread = new Thread(thread20);
        Thread thread1 = new Thread(thread21);
        thread.start();
        thread1.start();*/
//3
/*        Moped Moped = new Moped("Skoda", 2);
        ReentrantLock reentrantLock = new ReentrantLock();
        Runnable thr31 = new ReentrantLock1(Moped, reentrantLock);
        Runnable thr32 = new ReentrantLock2(Moped, reentrantLock);
        Thread thread1 = new Thread(thr31);
        Thread thread2 = new Thread(thr32);
        thread1.start();
        thread2.start();*/
//4
/*        ExecutorService threadPool = Executors.newFixedThreadPool(2);
        ...
        Vehicle moto1 = new Motorcycle("Polo",5);
        threadPool.execute(new Thread4(auto));
        threadPool.execute(new Thread4(auto1));
        threadPool.execute(new Thread4(moto));
        threadPool.execute(new Thread4(moto1));
        threadPool.shutdown();*/
//5
/*        String[] filePaths = new String[]{"auto0.txt", "auto1.txt", "auto2.txt", "auto3.txt", "auto4.txt"};
        ArrayBlockingQueue arrayBlockingQueue = new ArrayBlockingQueue<Vehicle>(1);
        for (int i = 0; i < filePaths.length; i++) {
            Thread5 transportThreadDlockingQueue = new Thread5(filePaths[i], arrayBlockingQueue);
            new Thread(transportThreadDlockingQueue).start();
        }
        for (int i = 0; i < filePaths.length; i++) {
            Auto auto = (Auto) arrayBlockingQueue.take();
            VehicleStaticClass.printModels(auto);
//            System.out.println(auto);
